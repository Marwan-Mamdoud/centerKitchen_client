...
const Page = () => {
  ...
  const getProducts = async () => {
    ...
    const cat = await getCategoryByName("Accessories");
    const data = await getProductByCategory("67722004fbfa9d0b1bbff3e9");
    setProducts(data);
    ...
    <div className="w-[100%] flex flex-col items-center justify-center">
      ...
      >
        <div className="flex items-center justify-start mr-8 gap-2">
          ...
          />
          <p className="[@media(max-width:1050px)]:text-2xl">Accessories</p>
        </div>
