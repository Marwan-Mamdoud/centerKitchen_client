...
import { getCategoryByName, getProductByCategory } from "@/lib/APIS";
...
const Page = () => {
  ...
  return (
    <div className="w-[100%] flex flex-col items-center justify-center">
      <div
        className={` h-[21dvh]  bg-cover bg-no-repeat p-10 bg-center w-full  text-white flex flex-col items-center justify-center gap-2 font-semibold text-5xl `}
      ...
      >
        <div className="flex items-center justify-start mr-8 gap-2">
          ...
          />
          <p className="[@media(max-width:1050px)]:text-2xl">
            {Category?.name?.en}
          </p>
        </div>
            ...
            <div className="grid grid-cols-4  [@media(max-width:1050px)]:flex [@media(max-width:1050px)]:justify-center items-start justify-items-start gap-5 w-full">
              <div className="flex flex-col items-start [@media(max-width:1050px)]:hidden justify-center gap-12">
                <div className="flex flex-col w-full items-start justify-center gap-5">
                  <p className="font-bold text-black/80 uppercase">
                    filter by price
                  </p>
                  <Slider
                  ...
                  <div className="flex flex-wrap items-center justify-start gap-2  w-full">
                    ...
                    <span className="min_number text-black/80 font-bold">
                      {range[0]?.toLocaleString() || 0}
                    </span>
                    <span className="font-bold text-black/80 uppercase text-sm">
                      aed
                    </span>
                    <CgBorderStyleSolid />
                    <span className="max_number text-black/80 font-bold ">
              ...
              <div className="col-span-3  w-full">
                <div className="w-full flex items-center justify-between [@media(max-width:1050px)]:justify-center [@media(max-width:1050px)]:flex-col">
                  ...
                  <div className="flex items-center justify-between [@media(max-width:1050px)] px-5 [@media(max-width:1050px)]:w-full ">
                    <button
                      onClick={() => show()}
                      className="font-bold uppercase text-black/80 flex items-center justify-center  gap-1 text-sm opacity-0 invisible [@media(max-width:1050px)]:opacity-100 [@media(max-width:1050px)]:visible"
                    >
                      <CgMenu className="w-5 h-5 text-black/60" />
                      Show sidebar
                    </button>
                    <button
